...
public class InAppPurchaseManager : MonoBehaviour, IStoreListener
{
    ...
    public static string kProductIDConsumable1 = "com.goodquestion.earthdefense.PurchaseCoins1"; // Tier 1
    public static string kProductIDConsumable3 = "com.sugamu.stackazoo.buy3"; // Tier 3
    ...
    private static string kProductNameGooglePlaySubscription = "com.sugamu.stackazoo";
